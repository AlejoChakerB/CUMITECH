    ...
    */
    ...
    'connections' => [
        ...
        'GoTelemedicina' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_EXTERNAL_HOST_GO', '10.1.11.245'),
            'port' => env('DB_EXTERNAL_PORT_GO', '3306'),
            'database' => env('DB_EXTERNAL_DATABASE_GO'),
            'username' => env('DB_EXTERNAL_USERNAME_GO'),
            'password' => env('DB_EXTERNAL_PASSWORD_GO'),
            'charset' => 'utf8mb4',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
        ...
        'PQ_CUMI' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PQ', '10.1.5.51'),
            'port' => env('DB_PORT_PQ', '3306'),
            'database' => env('DB_DATABASE_PQ'),
            'username' => env('DB_USERNAME_PQ'),
            'password' => env('DB_PASSWORD_PQ'),
            'charset' => 'utf8mb4',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
