<template>
  <v-container fluid>
    <v-row>
      <h6 class="tittle-color">INFORMES VARIOS</h6>
...
export default {
  ...
  data() {
    return {
      items: [
        { title: 'Ocupación', subtitle: 'Tablero de ocupación', description: 'Reporte de ocupación de los diferentes servicios: Hospitalización, UCI, Urgencias, etc', icon: 'mdi-bed', color_icon: '#046E73', route: 'occupation', permission: this.occupation }
      ],
      selectedDescription: '',
      hoverItem: null,
    }
