...
export default {
    ...
    data() {
        return {
            cards: [
                { hovered: false, title: 'Imagenes', description: 'Produccion mensual del servicio de imagenes', icon: 'mdi-radiology-box', image: this.imageSrc, color: "#32A997", route: this.imagingRoute },
                { hovered: false, title: 'CEXT', description: 'Produccion mensual del servicio de consulta externa', icon: 'mdi-doctor', image: this.imageSrc2, color: "#F279A2", route: this.cextRoute },
                { hovered: false, title: 'Cirugia', description: 'Produccion mensual del servicio de estancias', icon: 'mdi-doctor', image: this.imageSrc3, color: "#E8AB51", route: this.surgeryRoute },
                { hovered: false, title: 'Urgencias', description: 'Produccion mensual del servicio de urgencias', icon: 'mdi-doctor', image: this.imageSrc4, color: "#FF0000", route: this.urgencyRoute },
            ]
        };
    },
    methods: {
