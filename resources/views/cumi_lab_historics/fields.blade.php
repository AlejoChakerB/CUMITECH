...
<!-- Adminlog Field -->
<div class="form-group col-sm-6">
    {!! Form::label('adminlog', 'Adminlog:') !!}
    {!! Form::number('adminlog', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    {!! Form::label('cd', 'Cd:') !!}
    {!! Form::number('cd', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('cups', ], null, ['class' => 'form-control custom-select']) !!}
</div>
