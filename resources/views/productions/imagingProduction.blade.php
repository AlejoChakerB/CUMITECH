...
@section('content')
    <div>
        @can('export_productions_imaging')
    ...
    <div class="mt-3">
        <iframe title="COSTOS ESTANCIAS" width="100%" height="900px"
            src="https://app.powerbi.com/view?r=eyJrIjoiNzg1YTEyYTItMTYxNi00ZjU4LWExYjgtZmZmZDhlMDhlOWQyIiwidCI6Ijk4NGRkMTg1LWM4MDMtNGRhMS05NzRmLTcxZTQwYzc0ZWNjZCJ9"
