...
<div class="content">
    <div class="container-fluid" style="padding: 0 0">
        <div class=" d-flex justify-content-between mb-5"
            ...
            <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Presentadores</h3>
        </div>
        {{-- CARDS --}}
        {{--
        <div class="row">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
            ...
            <div class="d-flex flex-wrap justify-content-start">
                <form action="{{ route('presenters.index') }}" method="GET" class="d-flex mr-2 mb-2">
                ...
                <div class="mb-2">
                    @can('create_presenters')
                        <a href="{{ route('presenters.create') }}" class="btn btn-default" title="Agregar procedimiento" style="background-color: #2B3D63; color: white; position: relative;" id="btnAdd">
