...
<div class="content">
    <div class="container-fluid" style="padding: 0 0">
        <div class=" d-flex justify-content-between mb-5"
            ...
            <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Articulos</h3>
        </div>
        {{-- CARDS --}}
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text title-card">Dispositivos médicos</span>
                        <span class="info-box-number title-body">
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text title-card">Medicamentos POS</span>
                        <span class="info-box-number title-body">
                            {{ number_format($POS, 0, ',', '.'); }}
                        </span>
                    </div>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
            <div class="mb-2">
                @can('create_articles')
                    <a href="{{ route('get.articles') }}" class="btn btn-default buttom-left" title="Sincronizar articulos" id="syncButton">
            ...
            <div class="d-flex flex-wrap justify-content-start">
                <form action="{{ route('articles.index') }}" method="GET" class="d-flex mr-2 mb-2">
                    ...
                    <div class="input-group flex-grow-1 mr-2">
                        ...
                        <input type="text" class="form-control border-left-0 input flex-grow-1" name="search" placeholder="Buscar articulo médico" style="outline: none; box-shadow: none">
                    </div>
                </form>
        
                <div class="mb-2">
                    @can('create_articles')
                        <a href="{{ route('articles.create') }}" class="btn btn-default" title="Agregar articulo" style="background-color: #2B3D63; color: white; position: relative;" id="btnAdd">
