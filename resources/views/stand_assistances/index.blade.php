...
<div class="content">
    <div class="container-fluid" style="padding: 0 0">
        <div class=" d-flex justify-content-between mb-5"
            ...
            <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Asistencias a stand</h3>
        </div>
        {{-- CARDS --}}
        {{--
        <div class="row">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
            ...
            <div class="d-flex flex-wrap justify-content-start">
                <form action="{{ route('standAssistances.index') }}" method="GET" class="d-flex mr-2 mb-2">
                ...
                <div class="mb-2">
                    @can('create_standAssistances')
                        <a href="{{ route('standAssistances.create') }}" class="btn btn-default" title="Agregar procedimiento" style="background-color: #2B3D63; color: white; position: relative;" id="btnAdd">
        ...
        <div class="card shadow-none border-0 mt-3">
            <div class="card-body p-0">
                <div class="card-panel">
                    @include('stand_assistances.table')
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Stand Assistances</h1>
                </div>
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="{{ route('standAssistances.create') }}">
                        Add New
                    </a>
                </div>
            </div>
