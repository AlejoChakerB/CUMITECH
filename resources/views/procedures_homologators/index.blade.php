    ...
    <div class="content">
        <div class="container-fluid" style="padding: 0 0">
            <div class=" d-flex justify-content-between mb-5" style="background-color: transparent; padding: 0 0;">
                <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Homologador de cups</h3>
            </div>
            <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
                <div class="mb-2">
                    <a class="btn btn-default buttom-left-export" data-bs-toggle="modal" data-bs-target="#importar"
                        title="Importar homologaciones">
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <form action="{{ route('proceduresHomologators.index') }}" method="GET" class="d-flex mr-2 mb-2">
                        <div class="input-group mr-2" style="max-width: 100px;">
                            ...
                            <select class="custom-select border-left-0 input" id="perPageSelect" name="per_page"
                                ...
                                <option value="10" {{ $proceduresHomologators->perPage() == 10 ? 'selected' : '' }}>10
                                </option>
                                <option value="25" {{ $proceduresHomologators->perPage() == 25 ? 'selected' : '' }}>25
                                </option>
                                <option value="50" {{ $proceduresHomologators->perPage() == 50 ? 'selected' : '' }}>50
                                </option>
                                <option value="100" {{ $proceduresHomologators->perPage() == 100 ? 'selected' : '' }}>100
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="mb-2">
                        @can('create_surgeries')
                            <a href="{{ route('proceduresHomologators.create') }}" class="btn btn-default"
                                title="Agregar cirugia" style="background-color: #2B3D63; color: white; position: relative;"
                                id="btnAdd">
            ...
            <div class="card shadow-none border-0 mt-3">
                <div class="card-body p-0">
                    <div class="card-panel">
                        @include('procedures_homologators.table')
                    </div>
                </div>
            </div>
        </div>
