    ...
    <div class="content">
        <div class="container-fluid" style="padding: 0 0">
            <div class=" d-flex justify-content-between mb-5" style="background-color: transparent; padding: 0 0;">
                <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Detalles canasta</h3>
            </div>
            {{-- CARDS --}}
            <div class="row">
                <div class="col-md-3">
                    <div class="info-box">
                        ...
                        <div class="info-box-content" style="color: #2B3D63;">
                            <span class="info-box-text title-card">COSTO CANASTA</span>
                ...
                <div class="col-md-3">
                    <div class="info-box">
                        <span class="info-box-icon bg-blue elevation-1"><i data-feather="info" stroke-width="2"
                                width="40px" height="40px" id="loadContractBtn"></i></span>
                        <div class="info-box-content" style="color: #2B3D63;">
                            <span class="info-box-text title-card">Cantidad articulos</span>
                            <span class="info-box-number title-body">
                                {{ number_format($quanty, 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <form action="{{ route('baskets.index') }}" method="GET" class="d-flex mr-2 mb-2">
                        <div class="input-group mr-2" style="max-width: 100px;">
                            ...
                            <select id="perPageSelect" name="per_page" class="custom-select border-left-0 input"
                    ...
                    <div class="mb-2">
                        @can('create_baskets')
                            <a href="{{ route('baskets.create') }}" class="btn btn-default" title="Agregar contracto"
