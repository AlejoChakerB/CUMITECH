...
@section('content')
    <div class="row mb-5">
        <div class="mb-12 mt-2" style="color: #2B3D63;">
            <h1>Estancias disponibles</h1>
            <div class="mt-4">
                @can('reportbi_accommodationCosts')
                    <a href="{{ route('accomodation.report') }}" class="btn btn-default buttom-left" title="Mirar reporte">
                        <i data-feather="bar-chart" stroke-width="2" width="20px" height="20px"
                            id="loadContractBtn"></i><span>Reporte
                            PowerBi</span>
                    </a>
                @endcan
                @can('export_accommodationCosts')
                    <a class="btn btn-default buttom-left-export" data-bs-toggle="modal" data-bs-target="#export"
    ...
    <div id="app">
        <accommodation-component :image-src='{{ json_encode(asset('/images/icons/cifras.png')) }}'
            ...
            :service-Route='{{ json_encode(route('accommodationCosts.service')) }}'></accommodation-component>
    </div>
