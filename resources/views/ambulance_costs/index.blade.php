    ...
    <div class="content">
        <div class="container-fluid" style="padding: 0 0">
            <div class=" d-flex justify-content-between mb-4" style="background-color: transparent; padding: 0 0;">
                <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Costos servicios ambulancia</h3>
            </div>
            {{-- CARDS --}}
            {{-- <div class="row">
            <div class="col-md-3">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
                <div class="mb-2">
                    ...
                    @endcan
                    @can('reportbi_ambulanceCosts')
                        <a href="{{ route('ambulance_costs.report') }}" class="btn btn-default buttom-left"
                            title="Mirar reporte">
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <form action="{{ route('ambulanceCosts.index') }}" method="GET" class="d-flex mr-2 mb-2">
                        <div class="input-group mr-2" style="max-width: 100px;">
                            ...
                            <select class="custom-select border-left-0 input" id="perPageSelect" name="per_page"
                                ...
                                <option value="10" {{ $ambulanceCosts->perPage() == 10 ? 'selected' : '' }}>10</option>
                                <option value="25" {{ $ambulanceCosts->perPage() == 25 ? 'selected' : '' }}>25</option>
                                <option value="50" {{ $ambulanceCosts->perPage() == 50 ? 'selected' : '' }}>50</option>
                                <option value="100" {{ $ambulanceCosts->perPage() == 100 ? 'selected' : '' }}>100
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="mb-2">
                        @can('create_ambulanceCosts')
                            <a href="{{ route('ambulanceCosts.create') }}" class="btn btn-default" title="Agregar procedimiento"
    ...
    <div class="modal fade" id="importar" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('importAmbulance') }}" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="inputGroupFile01" data-browse="Buscar">Seleccionar un
                                    archivo...</label>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('download.ambulance') }}" class="btn btn-default buttom-left"
