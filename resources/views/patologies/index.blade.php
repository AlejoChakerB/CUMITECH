    ...
    <div class="content">
        <div class="container-fluid" style="padding: 0 0">
            <div class=" d-flex justify-content-between mb-4" style="background-color: transparent; padding: 0 0;">
                <h3 class="card-title m-0" style="font-size: 35px; color: #2B3D63;">Costos servicio patologia</h3>
            </div>
            {{-- CARDS --}}
            {{-- <div class="row">
            <div class="col-md-3">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
                <div class="mb-2">
                    ...
                    @endcan
                    @can('reportbi_patologies')
                        <a href="{{ route('patologies.report') }}" class="btn btn-default buttom-left" title="Mirar reporte">
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <form action="{{ route('patologies.index') }}" method="GET" class="d-flex mr-2 mb-2">
                    ...
                    <div class="mb-2">
                        @can('create_diferentialRates')
                            <a href="{{ route('patologies.create') }}" class="btn btn-default" title="Agregar procedimiento"
    ...
    <div class="modal fade" id="importar" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('importPatology') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('download.patologies') }}" class="btn btn-default buttom-left"
